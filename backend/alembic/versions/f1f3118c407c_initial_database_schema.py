...
def upgrade() -> None:
    ...
    sa.Column('tags', app.models.grant.JSONType(), nullable=True),
    ...
    sa.Column('required_documents', app.models.grant.JSONType(), nullable=True),
    sa.Column('application_form_fields', app.models.grant.JSONType(), nullable=True),
    ...
    sa.Column('form_data', app.models.grant.JSONType(), nullable=True),
    sa.Column('documents', app.models.grant.JSONType(), nullable=True),
    sa.Column('status', sa.String(length=20), nullable=True),
